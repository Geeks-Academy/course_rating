...
class getDoctrine_Dbal_DefaultConnectionService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['host' => '%env(resolve:MYSQL_HOST)', 'user' => '%env(resolve:MYSQL_USER)', 'password' => '%env(resolve:MYSQL_PASSWORD)', 'driver' => 'pdo_mysql', 'dbname' => '%env(resolve:MYSQL_DATABASE)', 'port' => NULL, 'driverOptions' => [], 'defaultTableOptions' => []], $a, $c, []);
    }
}
